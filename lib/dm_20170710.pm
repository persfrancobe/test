		...
		<div class="save-top">
			<div class="row">
				...
				<div class="col-md-6  text-right">
					<a data-placement="bottom" data-original-title="$migctrad{back}" class="btn btn-sm btn-default show_only_after_document_ready cancel_edit c2" aria-hidden="true">$ICONCANCEL</a>
...
EOH
		...
		<div class="save-top">
			<div class="row">
				...
				<div class="col-md-6  text-right">
					<a data-placement="bottom" data-original-title="$migctrad{back}" class="btn btn-sm btn-default show_only_after_document_ready cancel_edit c3" aria-hidden="true">$ICONCANCEL</a>
					$custom_button_xs
					$etapeFinale_button_xs
					$button_save
...
# EOH
	...
	<div class="row">
		...
		<div class="alert alert-danger validation_msg hide text-left">
			...
			<a data-placement="bottom" data-original-title="$migctrad{back}" class="btn btn-lg btn-default show_only_after_document_ready cancel_edit c4" aria-hidden="true">$ICONCANCEL</a>
			$custom_button_lg
...
sub get_operations_div
{
	...
	<div class="row">
		<div class="col-md-12 text-right">
								<a data-placement="bottom" data-original-title="$migctrad{back}" class="btn btn-sm btn-default show_only_after_document_ready cancel_edit c5" aria-hidden="true">$ICONCANCEL</a>
	...
	<div class="row">
		<div class="col-md-12 text-right">
								<a data-placement="bottom" data-original-title="$migctrad{back}" class="btn btn-sm btn-default show_only_after_document_ready cancel_edit c6" aria-hidden="true">$ICONCANCEL</a>
...
EOH
	...
	<div class="row">
		<div class="col-md-12 text-right">
					<a data-placement="bottom" data-original-title="$migctrad{back}" class="btn btn-lg btn-default show_only_after_document_ready cancel_edit c7" aria-hidden="true">$ICONCANCEL</i></a>
