...
$(document).ready(function() 
{
	...
	var parametre_colg = jQuery('.parametre_url_colg').val();
	if(parametre_colg > 1)
	{
		jQuery('.edit_switch_language1.btn-info').click();
	}
...
function init_data_types()
{
	...
	{
		var me = $(this);
		var url = $("#script_self").val()+'&sw=autocomplete_query&field='+me.attr('name');
...
function bugi_link_browser(field_name, url, type, win)
{
      ...
      request.done(function(msg) 
      {
		 ...
		 // $('#mig_files_manger_container').load('adm_migcms_file_manager.pl?sw=list_files&pick_link=y&sel=1000159');
		   jQuery.ajax(
		  {
			 type: "GET",
