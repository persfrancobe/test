...
############# REWRITE #############
$config{rewrite_dns}       = "dev.bugiweb.net";
$config{rewrite_subdns}    = "certigreen.";
$config{rewrite_directory} = "";
$config{directory_path}    = "/var/www/vhosts/certigreen.dev.bugiweb.net/httpdocs";
$config{rewrite_host}      = $config{rewrite_subdns}.$config{rewrite_dns};
$config{rewrite_base}      = $config{rewrite_directory}."/";

############# DATABASE #############
$config{projectname}       = "certigreen-auto";
$config{db_name}           = "DBI:mysql:$config{projectname}";
$config{db_user}           = "root";
$config{db_passwd}         = "trustn01";
