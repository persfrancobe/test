...
$dm_cfg{wherel}           = "";
$dm_cfg{wherep}           = "";
$dm_cfg{table_name}       = "widgets";
$dm_cfg{list_table_name}  = "$dm_cfg{table_name}";
$dm_cfg{table_width}      = 850;
$dm_cfg{fieldset_width}   = 850;
my $self                  =$dm_cfg{self} = "$config{baseurl}/cgi-bin/adm_migcms_widgets.pl?";
